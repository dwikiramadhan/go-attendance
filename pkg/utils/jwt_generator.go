...
func GenerateNewTokens(id, emp_no string) (*Tokens, error) {
	// Generate JWT Access token.
	accessToken, err := generateNewAccessToken(id, emp_no)
	if err != nil {
...
func generateNewAccessToken(id, emp_no string) (string, error) {
...
// func verifyRefreshToken(refresh string) (string, error) {
// 	// Set secret key from .env file.
